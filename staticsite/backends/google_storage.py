...
discovery = check_publisher_dependencies('staticsite.backends.google_storage', 'googleapiclient', 'discovery')
storage = check_publisher_dependencies('staticsite.backends.google_storage', 'google.cloud', 'storage')
    ...
    def authenticate(
        ...
        if credentials_file:
            ...
            if not credentials_path.is_file():
                raise StaticSitePublishError(f'Static site backend for Google Cloud Storage '
