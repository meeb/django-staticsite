...
def get_uri_values(func: FunctionType, view_name: str) -> list[str | int | None]:
    ...
    if isinstance(v, (list, tuple)):
        ...
        raise StaticSiteError(
            f"Unable to get staticsite URI values, "
...
def generate_uri(
    ...
    if isinstance(param_set, (list, tuple)):
        ...
        raise StaticSiteError(
            f"Unable to generate staticsite URI, "
...
def generate_filename(
    file_name: str, uri: str, param_set: list[str | None] | tuple[str | None]
) -> str | None:
